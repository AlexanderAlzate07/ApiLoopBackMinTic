...
> {
  ...
  constructor(
    @inject('datasources.mongodatasource') dataSource: MongodatasourceDataSource, @repository.getter('EstacionRepository') protected estacionRepositoryGetter: Getter<EstacionRepository>,
  ) {
